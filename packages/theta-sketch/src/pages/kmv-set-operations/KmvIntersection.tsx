...
const OPENING_NARRATION_1 = `
  Because the intersection result may have fewer than K values, so inferred theta from the new sketch may not match the operation theta.
...
const NARRATION: Record<number, string> = {
    ...
    8: "For intersection, theta is not inferred from result values; it is min(theta A, theta B). So we should store theta explicitly to make the result composable for further set operations.",
};
